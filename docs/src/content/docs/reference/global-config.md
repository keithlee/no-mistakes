...
| Variable | Value |
| --- | --- |
| `{{.Step}}` | Pipeline step name, such as `review`, `test`, `proof`, `proof-review`, `document`, `lint`, or `ci` |
