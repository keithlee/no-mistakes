...
var migrationStatements = []string{
	`CREATE TABLE IF NOT EXISTS feedback_reconciliation (run_id TEXT NOT NULL REFERENCES runs(id) ON DELETE CASCADE, item_id TEXT NOT NULL, item_json TEXT NOT NULL, source_head TEXT NOT NULL, repaired_head TEXT, validated_head TEXT, replied INTEGER NOT NULL DEFAULT 0, updated_at INTEGER NOT NULL, PRIMARY KEY (run_id, item_id))`,
